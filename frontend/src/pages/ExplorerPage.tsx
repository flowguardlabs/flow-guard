          ...
          <div className="flex items-center gap-2 mb-4 overflow-x-auto pb-2">
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-3 rounded-lg font-sans font-medium transition-all whitespace-nowrap ${
                  viewMode === mode
                  ...
                  <div key={idx} className="flex gap-4 p-4 bg-surfaceAlt rounded-lg hover:bg-surface transition-colors border border-border">
                    <div className="flex-shrink-0">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                        event.type === 'VAULT_CREATED' ? 'bg-primary/10 border border-primary' :
