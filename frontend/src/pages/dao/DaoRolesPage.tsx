    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-8 md:px-8">
            <div className="mb-8">
                ...
                <p className="text-textSecondary">Configure permissions architectures and protocol roles.</p>
            </div>
            ...
            <div className="bg-surfaceAlt border border-border rounded-2xl p-8 mb-8 text-center max-w-2xl mx-auto mt-12">
                ...
                <h2 className="text-2xl font-bold text-textPrimary mb-4">Coming Soon: Role Systems</h2>
                ...
                <ul className="text-left text-sm text-textSecondary space-y-3 mb-10 max-w-md mx-auto">
                    <li className="flex items-center gap-3">
                        ...
                        Configure custom permission hierarchies for organizational logic.
                    </li>
                    <li className="flex items-center gap-3">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#00E676] shrink-0" />
                        Assign execution, voting, and auditing capabilities dynamically.
                    </li>
                    <li className="flex items-center gap-3">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#00E676] shrink-0" />
                        Integrate with on-chain role enforcement caching.
                    </li>
                </ul>

                <Link to="/proposals" className="inline-flex items-center justify-center bg-[#1a1a1a] text-white px-6 py-3 rounded-xl font-medium hover:bg-black transition-colors shadow-lg shadow-black/5">
                    View Current Proposals <ArrowRight className="w-4 h-4 ml-2" />
                </Link>
            </div>
        </div>
    );
