    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-8 md:px-8">
            <div className="mb-8">
                ...
                <p className="text-textSecondary">Manage organizational members and on-chain identity.</p>
            </div>
            ...
            <div className="bg-surfaceAlt border border-border rounded-2xl p-8 mb-8 text-center max-w-2xl mx-auto mt-12">
                ...
                <h2 className="text-2xl font-bold text-textPrimary mb-4">Coming Soon: Team Management</h2>
                ...
                <ul className="text-left text-sm text-textSecondary space-y-3 mb-10 max-w-md mx-auto">
                    <li className="flex items-center gap-3">
                        ...
                        Manage organization members and multisigners uniformly.
                    </li>
                    <li className="flex items-center gap-3">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#00E676] shrink-0" />
                        Invite users via CashToken registry or wallet address.
                    </li>
                    <li className="flex items-center gap-3">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#00E676] shrink-0" />
                        View global activity streams assigned to individual members.
                    </li>
                </ul>
                ...
                <Link to="/vaults" className="inline-flex items-center justify-center bg-[#1a1a1a] text-white px-6 py-3 rounded-xl font-medium hover:bg-black transition-colors shadow-lg shadow-black/5">
                    View Treasuries <ArrowRight className="w-4 h-4 ml-2" />
                </Link>
            </div>
        </div>
    );
